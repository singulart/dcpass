...
import { sampleWithRequiredData } from '../pass-contract.test-samples';
import { PassContractService } from '../service/pass-contract.service';

import { PassContract } from './pass-contract';

describe('PassContract Management Component', () => {
  let comp: PassContract;
  let fixture: ComponentFixture<PassContract>;
  ...
  beforeEach(() => {
    ...
    fixture = TestBed.createComponent(PassContract);
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.passContracts()[0]).toEqual(expect.objectContaining({ id: 13513 }));
  });

  describe('trackId', () => {
    it('should forward to passContractService', () => {
      const entity = { id: 13513 };
      vitest.spyOn(service, 'getPassContractIdentifier');
      const id = comp.trackId(entity);
      expect(service.getPassContractIdentifier).toHaveBeenCalledWith(entity);
