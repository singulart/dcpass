...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, io.argorand.poc.dcpass.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, io.argorand.poc.dcpass.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, io.argorand.poc.dcpass.domain.PurchaseOrder.class.getName());
            createCache(cm, io.argorand.poc.dcpass.domain.PassPayment.class.getName());
